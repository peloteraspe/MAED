...
export const ButtonWrapper: React.FC<ButtonWrapperProps> = ({
  ...
  return (
    <button
      className={`${buttonWidth} px-3 py-[0.75rem] font-semibold bg-primary hover:bg-primary-dark hover:shadow text-white rounded-md my-0 flex justify-center items-center relative box-border ${
...
export const ButtonUnWrapperOutline: React.FC<ButtonWrapperProps> = ({
    ...
    return (
      <button
        className={`${buttonWidth} px-3 py-[0.75rem] ${bg} font-semibold text-btnBg-light hover:bg-transparent hover:text-btnBg-dark rounded-md my-0 flex justify-center items-center relative box-border ${
          disabled ? "cursor-auto" : "cursor-pointer"
        } `}
        onClick={onClick}
        disabled={disabled}
